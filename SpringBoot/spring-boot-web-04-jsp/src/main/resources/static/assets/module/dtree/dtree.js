...
layui.define(['jquery','layer','form'], function(exports) {
    ...
    var defaultMenu = {
        ...
        mySearchNode: "mySearchNode"	//menubar查询节点
    };
...
//			level: "level",			  //层级
        ...
        this.menubarTips = {  // 菜单栏的默认显示
            toolbar: [],
            group: [defaultMenu.moveDown, defaultMenu.moveUp, defaultMenu.refresh, defaultMenu.checkAll, defaultMenu.unCheckAll, defaultMenu.invertAll, defaultMenu.remove, defaultMenu.searchNode,, defaultMenu.mySearchNode],
            freedom: []
        };
        this.checkbarFun = {
    ...
    DTree.prototype.getMenubarDom = function(menu){
        ...
        switch (menu) {
            ...
            case defaultMenu.searchNode:
                ...
                break;
            case defaultMenu.mySearchNode:
                gg = "<button type='button' class='layui-btn layui-btn-sm layui-btn-primary' dtree-id='"+rootId+"' d-menu='"+defaultMenu.mySearchNode+"' title='查询节点'><i class='"+_this.usefontStyle.menubar.search+"'></i></button>";
                break;
        }
        return gg;
    };
    ...
    DTree.prototype.getMenubarToolDom = function(menu){
        ...
        switch (menu) {
            ...
            case defaultMenu.searchNode:
                ...
                break;
            case defaultMenu.mySearchNode:
                _this.toolbarMenu[defaultMenu.mySearchNode] = _this.setToolbarDom().setMenuToolbarOption(defaultMenu.mySearchNode, _this.toolbarStyle.title, _this.usefontStyle.toolbar.menubar.mySearchNode, "查询");
                break;
        }
    };
    ...
    DTree.prototype.menubarMethod = function(){
        ...
        return {
            ...
            mySearchNode: function(){//模糊查询该值，展开该值节点
                layer.prompt({
                    formType: 0,
                    value: "",
                    title: '查询节点'
                    ...
                    if (value) {
                        var flag = _this.mySearchNode(value);
                        if (!flag) {
                            layer.msg("该名称节点不存在！", {icon:5});
                        }
                    } else {
    ...
    DTree.prototype.menubarListener = function(menuId, flag){
        ...
        switch (menuId) {
            ...
            case defaultMenu.searchNode:
                ...
                break;
            case defaultMenu.mySearchNode:
                _this.menubarMethod().mySearchNode();
                break;
            default:
    ...
    /**
     * @Desc: 模糊查询该值，展开所有节点，该值节点高亮
     * @Param: value： 模糊查询的值
     * @author:雪城软件公司-赵紫龙
     */
    DTree.prototype.mySearchNode = function(value){
        var _this = this;
        var item = undefined;
        _this.obj.find("div").css("background","");
        _this.obj.find("cite[data-leaf]").each(function(){
            var $nthis = $(this);
            var html = $nthis.html();
            if(html.indexOf(value) > -1){
                $nthis.parents("li").each(function(){
                    var html2 = $(this).find("cite[data-leaf]").html();
                    if(html2.indexOf(value) > -1){
                        $(this).find("div").css("background-color","#F2F9FF");
                        item = $(this);
                    }
