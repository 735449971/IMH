...
layui.define(['jquery','layer','form'], function (exports) {
	"use strict";
  	...
  	,sliderVerify = {
	  	read : function(){
	  		var css = '.slider-item{height:38px;line-height:38px;background-color:#d2d2d2;position:relative;border: 1px solid white;}.slider-bg{position:absolute;width:40px;height:100%;z-index:100}.slider-btn{width:40px;height:96%;position:absolute;border:1px solid #ccc;cursor:move;text-align:center;background-color:#fff;user-select:none;color:#666;z-index:120}.slider-btn-success{font-size:26px}.slider-text{position:absolute;text-align:center;width:100%;height:100%;user-select:none;font-size:14px;color:#fff;z-index:120}.slider-error{animation:glow 800ms ease-out infinite alternate;}@keyframes glow{0%{border-color:#e6e6e6}100%{border-color:#ff5722}}  .layui-sider-green{background-color: #5fb878!important} ',
  	...
  	MOD_DEFAULT_BG = 'layui-sider-green',
